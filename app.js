...
app.get('/register', (req, res) => res.render('views/pages/register'));
app.get('/login', (req, res) => res.render('views/pages/login'));
app.get('/admin-home', (req, res) => res.render('views/pages/AdminHome'));
